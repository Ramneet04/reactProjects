import image1 from './RaghavImage.jpeg'
import image2 from './RamneetImage.jpeg'
import image3 from './Puneet.jpeg'
const reviews = [
    {
      id: 1,
      name: "Pranay Gupta",
    ...
    },
    {
      ...
      image: image1,
      text: "Meet Raghav Gupta, a seasoned blockchain developer with a passion for crafting innovative solutions in the decentralized world. Armed with a comprehensive understanding of blockchain technology, Raghav has emerged as a driving force in the realm of distributed ledger systems.",
    },
    {
      id: 7,
      name: "Ramneet Singh",
      ...
      image: image2,
      text: "Meet Ramneet Singh, a dynamic and versatile full-stack developer at the forefront of creating comprehensive and seamless web applications. With a keen eye for both front-end aesthetics and back-end functionality, Ramneet is the driving force behind the success of numerous digital ventures."
    },
    {
      id: 8,
      name: "Puneet Khatri",
      job: "Java Developer",
      image: image3,
      text: "Puneet Khatri is a skilled and experienced Java developer, known for his proficiency in Java programming and related technologies. With a strong foundation in software development, Puneet is well-versed in designing, implementing, and maintaining Java-based applications. He possesses a deep understanding of object-oriented programming principles and is adept at leveraging Java frameworks to build robust and scalable software solutions."
    },
  ];
